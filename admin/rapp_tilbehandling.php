...
$query=" SELECT * FROM fiksgrafitti where status like 'tilbehandlet' order by id desc limit $eu, $limit ";
...
echo "<B><font face='Verdana' size='1'>Dato: $noticia[dato]<br>Saken gjelder: $noticia[feil]</B><br>Adresse: $noticia[sted] Status: $noticia[status]</font><br><font face='Verdana' size='1'>Problem: $noticia[problem]<br><br><font face='Verdana' color=red size='1'>Kommentar: $noticia[kommentar]<br></td>"; 
